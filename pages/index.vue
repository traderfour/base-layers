        ...
        <div class="py-8 mx-auto max-w-screen-xl ">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="p-4 w-full rounded-lg"
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Roberta drives the technical
                            strategy of the themesberg platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Neil Sims drives the technical
                            strategy of the themesberg platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Joseph drives the technical
                            strategy of the themesberg platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <span class="text-gray-500">Senior Front-end Developer</span>
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Thomas drives the technical
                            strategy of the themesberg platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
