<template>
  <footer class="ltr:hidden bg-gray-50 dark:bg-gray-800 rounded-xl">
    <div
      class="rounded-xl grid grid-cols-2 gap-8 lg:grid-cols-6 rtr:hidden bg-white shadow p-4 md:p-6 xl:p-8 dark:bg-gray-800 md:flex md:items-center md:justify-between"
    >
      <div class="col-span-2">
        ...
        >
          <img class="w-8 h-8" src="/img/logo.svg" />
          Trader4
        </NuxtLink>
      ...
      <div class="lg:mx-auto">
        ...
        <ul class="text-gray-500 dark:text-gray-400">
          <li v-for="(link, index) in downloadLinks" :key="index" class="mb-4">
            <NuxtLink class="hover:underline" :to="link.link">
              {{ link.title }}
            </NuxtLink>
          </li>
    ...
    <div
      class="bg-white shadow p-4 md:p-6 xl:p-8 dark:bg-gray-800 md:flex md:items-center md:justify-between rounded-xl"
    >
      <div class="mb-4 xl:flex xl:items-center xl:space-x-3 md:mb-0">
        ...
        <ul class="flex justify-center items-center">
          ...
          <li>
            <a
              href="#"
              class="mr-3 text-gray-900 underline hover:no-underline dark:text-white"
              >API</a
            >
          </li>
          <li>
            <a
              href="#"
              class="text-gray-900 mr-3 underline hover:no-underline dark:text-white"
              >Contact</a
            >
          </li>
        </ul>
      ...
      <div class="flex justify-center items-center space-x-3">
        ...
        >
          ...
          <img
            ...
            alt="trader4-farsi"
            class="rounded-full h-4 w-5 ml-1.5 mr-4"
          />
          Farsi
          <svg
  ...
  <footer class="rtl:hidden bg-gray-50 dark:bg-gray-800 rounded-xl">
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10">
      ...
      />
      <div
        class="rounded-lg sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8"
      >
        <p
