<template>
    <footer class="bg-white dark:bg-gray-800 rounded">
        <div class="p-4 mx-auto lg:-10">
            <div class="grid pt-4 grid-cols-2 gap-8 lg:grid-cols-5">
                <div class="lg:mx-auto">
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-white">Quick Access</h2>
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li v-for="(link, index) in quickLinks" :key="index" class="mb-4 text-xs">
                ...
                <div class="lg:mx-auto">
                    ...
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li v-for="(link, index) in productsLinks" :key="index" class="mb-4 text-xs">
                            <NuxtLink class="hover:underline" :to="link.link">
                                {{ link.title }}
                            </NuxtLink>
                        </li>
                ...
                <div class="lg:mx-auto">
                    ...
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li
                                ...
                                class="mb-4 text-xs"
                        >
                            <NuxtLink class="hover:underline" :to="link.link" :target="link.target ?? undefined">
                                {{ link.title }}
                            </NuxtLink>
                        </li>
                    </ul>
                ...
                <div class="lg:mx-auto">
                    ...
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li v-for="(link, index) in moreLinks" :key="index" class="mb-4 text-xs">
                            <NuxtLink class="hover:underline" :to="link.link">
                                {{ link.title }}
                            </NuxtLink>
                        </li>
                ...
                <div class="lg:mx-auto">
                    ...
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li v-for="(link, index) in familyLinks" :key="index" class="mb-4 text-xs">
                            <NuxtLink class="hover:underline" :to="link.link" :target="link.target??undefined">
                                {{ link.title }}
                            </NuxtLink>
                        </li>
            ...
            <div class="pt-10 max-w-screen-xl text-center">
                <div class="grid lg:grid-cols-2">
                    <NuxtLink :to="localepath('/')" class="flex items-center mb-4 text-2xl font-semibold text-gray-900 lg:mb-0 dark:text-white">
                        <img
                ...
                <div class="sm:items-center sm:justify-between sm:flex">
                    <span class="block text-sm text-gray-500 dark:text-gray-400">© 2017-2023 <a href="https://trader4.net" class="hover:underline">Trader4</a>. All Rights Reserved.</span>
                    <div class="flex flex-wrap items-center mb-4 text-sm text-gray-500 lg:mb-0 dark:text-gray-400">
                        <p>Proudly Part Of <a href="https://briofy.net" target="_blank" rel="external" class="hover:underline font-semibold">Briofy</a> Family</p>
                    </div>
...
const supportLinks = ref([
    ...
    { title: "Status System", link: "https://status.trader4.net", target:"_blank"},
