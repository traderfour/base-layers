<template>
  <footer
    class="ltr:hidden bg-white rounded-lg shadow p-4 md:p-6 xl:p-8 dark:bg-gray-800 md:flex md:items-center md:justify-between">
  ...
  <footer
    class="rtl:hidden bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800">
    <p
