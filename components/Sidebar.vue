<template>
  <aside class="absolute top-24 mx-5 lg:mx-0 lg:top-5 left-0 z-40 w-64 rtl:right-0">
    <div
      ...
      <ul class="space-y-2">
        <li v-for="(item, index) in sideBarItems" :key="index" :class="
          item.breakdown
    ...
    <div
      ...
      <button v-if="colorMode.preference === 'light'" id="theme-toggle" @click="colorMode.preference = 'dark'"
        type="button"
        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
        <Icon size="1.25rem" name="mdi:weather-night" />
      </button>
      <button id="theme-toggle" @click="colorMode.preference = 'light'" v-if="colorMode.preference === 'dark'"
        type="button"
        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
        <Icon size="1.25rem" name="mdi:weather-sunny" @click="colorMode.preference = 'light'" />
      </button>
      <a href="#"
        ...
        <ul class="py-1" role="none">
          ...
          <li>
            <NuxtLink :to="switchLocalePath('fa')"
              ...
              role="menuitem">
              <div class="inline-flex items-center">
                <img src="../public/img/icon/ir.svg" alt="trader4-farsi" class="h-3.5 w-3.5 rounded-full mr-2" />
                Farsi
              </div>
            </NuxtLink>
          </li>
