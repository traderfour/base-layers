<template>
  ...
  <div
    ...
    aria-hidden="false"
    tabindex="-1"
    class="hidden overflow-y-auto overflow-x-hidden w-full md:inset-0 h-modal md:h-full"
  >
    <div
      class="p-4 w-full absolute bottom-0 z-50 right-0 max-w-xl h-full md:h-auto"
    >
