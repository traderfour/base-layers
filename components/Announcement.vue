<template>
  ...
  <div id="banner" tabindex="-1"
    class="flex fixed z-50 justify-between rounded-lg top-2 right-2 py-3 px-4 w-100 bg-gray-50 border border-b border-gray-200 dark:border-gray-700 dark:bg-gray-800">
    <div class="flex items-center mx-auto">
      <p class="text-sm font-medium text-gray-900 md:my-0 dark:text-white">
        ...
        <NuxtLink
          ...
          :to="item.link.src">
          {{ item.link.text }}
          <svg class="ml-1 w-4 h-4 text-blue-600 dark:text-blue-500" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
